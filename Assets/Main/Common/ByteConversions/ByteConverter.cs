...
namespace Common.ByteConversions
{
    public static class ByteConverter
    {
        ...
        public static IEnumerable<byte> ToBytes(this Vector3 value) => value.x.ToBytes().Concat(value.y.ToBytes()).Concat(value.z.ToBytes());
        ...
        public static (T result, int bytesRead) Get<T>(this byte[] bytes, int startIndex = 0)
        ...
        public static Vector3 ToVector3(this byte[] bytes, int startIndex = 0) =>
                new Vector3(bytes.ToFloat(startIndex), bytes.ToFloat(startIndex + sizeof(float)), bytes.ToFloat(startIndex + 2 * sizeof(float)));
        ...
        public static (T[] result, int bytesRead) GetList<T>(this byte[] bytes, int startIndex = 0)
                where T : IByteAssignable, new()
        {
            var length = bytes.ToInt(startIndex);
            var readCount = sizeof(int);
