...
namespace RL.Serialization
{
    /// <summary>
    ///     We are using this attribute to mark members of our state and action that will be used in training, so that we know the size of data which we are sending
    ///     and receiving from backend
    /// </summary>
    ...
    public class StructuralAttribute : Attribute
    {
        ...
        /// <summary>
        ///     Returns the total number of floats in a type. Searches for <see cref="Vector3"/>, <see cref="Vector2"/> and float members, marked with the [Structural]
        ///     attribute
        /// </summary>
                ...
                switch (member) {
                    case FieldInfo fieldInfo: {
                        ...
                        if (type == typeof(float))
                            ...
                            sum                               += 2;
                        else if (type == typeof(Vector3)) sum += 3;
                        break;
                    }
