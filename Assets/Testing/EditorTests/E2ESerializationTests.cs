...
namespace Testing.EditorTests {
    public class E2ESerializationTests {
        ...
        [Test] public void CanSerializeInt() {
            const int value = 5;
        ...
        [Test] public void CanSerializeFloat() {
        ...
        [Test] public void CanSerializeString() {
        ...
        [Test] public void CanSerializeListInt() {
            var value = new[] {1, 2, 3};
            var (response, startIndex) = SendToParse(value);
        ...
        [Test] public void CanSerializeListFloat() {
        ...
        [Test] public void CanSerializeTensorRandom() {
        ...
        [Test] public void CanSerializeStateDict() {
        ...
        [Test] public void CanSerializeStateDictComplex() {
        ...
        static (byte[] response, int startIndex) SendToParse(int data) =>
            Communicator.Send(RequestType.Echo, "int".ToBytes().Concat(data.ToBytes()));

        static (byte[] response, int startIndex) SendToParse(float data) =>
            Communicator.Send(RequestType.Echo, "float".ToBytes().Concat(data.ToBytes()));

        static (byte[] response, int startIndex) SendToParse(string data) =>
            Communicator.Send(RequestType.Echo, "string".ToBytes().Concat(data.ToBytes()));
        ...
        static (byte[] response, int startIndex) SendToParse(Tensor data) =>
            Communicator.Send(RequestType.Echo, "tensor".ToBytes().Concat(data.ToBytes()));
