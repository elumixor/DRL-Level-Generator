...
{
    /// <summary>
    ///     We have an an Environment behaviour, which contains a child Agent behaviour. This object can thus also represent an
    ///     EnvironmentInstance, by providing itself as Environment, and its Agent child as an Agent.
    /// </summary>
    /// <remarks>
