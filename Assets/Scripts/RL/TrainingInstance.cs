...
namespace RL
{
    public class TrainingInstance<TState, TAction>
    {
        readonly IEnvironment<TState, TAction> environment;
        readonly IAgent<TState, TAction> agent;

        // Samples for the episode we are collecting
        ...
        public TrainingInstance(IEnvironment<TState, TAction> environment, IAgent<TState, TAction> agent)
        {
