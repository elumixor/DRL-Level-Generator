...
// {
//     public class Environment : EnvironmentInstance<Vector, int, Agent>
//     {
...
//
//         /// <inheritdoc/>
//         public override Vector ResetEnvironment()
//         {
...
//
//         /// <inheritdoc/>
//         public override (Vector newState, float reward, bool isDone) Step(int action)
//         {
...
//
//             return (new Vector(x), reward, done);
//         }
//     }
// }
